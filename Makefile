...
SRC	= main.cpp file.cpp buffer.cpp aho_context.cpp lru_cache.cpp application.cpp pattern_actions.cpp actions.cpp parse.cpp utilities.cpp
...
utilities.o: utilities.cpp
	$(CC) $(CPPFLAGS) -c utilities.cpp -o utilities.o 
